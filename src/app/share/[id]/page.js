  ...
  return (
    <div className="share-layout">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .player-preview:hover { background: linear-gradient(135deg, #334155, #0f172a); }
        .play-icon-circle { width: 64px; height: 64px; background: rgba(6, 182, 212, 0.9); border-radius: 50%; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; margin-bottom: 12px; }
        .play-icon-circle svg { width: 28px; height: 28px; fill: white; margin-left: 4px; }
        .preview-text { font-size: 16px; font-weight: 800; letter-spacing: 0.5px; }
